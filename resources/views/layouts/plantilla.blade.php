            ...
            <div class="row">
                ...
                <div class="col-xs-10 text-right menu-1 main-nav">
                    <ul>
                        ...
                        <li class="btn-cta"><a class="external" href=index.html><span>INICIAR SESIÓN</span></a></li>
                    </ul>
                </div>
                <div>
                    @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        ...
                        <a href="{{ route('cache') }}" class="text-sm text-gray-700 underline">Caché</a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="gtco-practice-area-item animate-box">
                        <div class="gtco-icon">
                            <img src="images/vaso.png" alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
                        </div>
                        <div class="gtco-copy">
