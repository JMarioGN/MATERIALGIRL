...
@if( \Auth::user()->roles_id== 1 ) 
    <a href="{{route('roles.create')}}" class=" btn btn-primary btr"><span class="oi oi-plus"></span></a>
                <b>Nuevo rol</b> <br> <br> 
    @else 
                    ...
                    @foreach($table as $row)
                        <tr>
                            <td>
                                ...
                                @else 
                                <a href="{{route('roles.show', $row->id)}}" class="a">{{$row->nombre}} <span class="oi oi-eye"></span></a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
