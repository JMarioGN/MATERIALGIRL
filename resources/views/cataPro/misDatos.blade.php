...
<div class="d-flex justify-content-center">
    <div class="ch">
        <a href="{{ route('home', $modelo->id) }}" class=" btn btn-primary btr"><span class="oi oi-chevron-left"></span></a>
        <b>Regresar</b> <br> <br>
        ...
        {{ Form::model( $modelo, array('route' => array('misDatos-actualiza', $modelo->id), 'method' => 'POST') ) }}
