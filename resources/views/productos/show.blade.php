...
<a href="{{route('productos.index')}}" class=" btn btn-primary btr"><span class="oi oi-chevron-left"></span></a><b> Regresar</b> <br><br>
            ...
            <tr  class="tr">
                ...
                <th>
                    {{ Form::open(array('url' => route('productos.destroy', $modelo->id), 'class' => 'pull-right')) }}
                        <a class="btn btn-primary pull-left" href="{{route('productos.edit', $modelo->id)}}"><span class="oi oi-pencil"></span></a>
